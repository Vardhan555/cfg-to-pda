...
if __name__ == "__main__":
    states, transitions = Grammar.importGrammar("C:/Users/SAI VARDHAN VEGI/Downloads/cfg-to-pda/cfg-to-pda/Samples/grammar2.txt")
    ...
    #while(True):
        ...
        #if (inp != "Y"): break
        #string = input("C:/Users/SAI VARDHAN VEGI/Downloads/cfg-to-pda/cfg-to-pda/Samples/grammar1y-strings.txt").strip()
